...
class CategoryEndpoint(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save() #calls the create or update method on the request type
...
class ProductUpdateEndpoint(generics.UpdateAPIView):
    queryset=Product.objects.all()
    serializer_class=ProductSerializer
    lookup_field="pk"
...
class CategoryUpdateEndpoint(generics.UpdateAPIView):
    queryset=Category.objects.all()
    serializer_class=CategorySerializer
    lookup_field="pk"
...
class ProductDetailEndpoint(APIView):
    ...
    def deleteut(self, request, *args, **kwargs):
        product=self.get_object(id=self.kwargs['product_id'])
        product.delete()
